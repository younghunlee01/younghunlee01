...
### 2. 서버 구성 (05)
- 🙋 [SSH Server](docs/05-servers-ssh.md)
- [XRDP Server](docs/05-servers-xrdp.md)
- 🙋 [DNS Server](docs/05-servers-dns.md)
- 🙋 [Web & FTP Server](docs/05-servers-web-ftp.md)
- [NFS Server](docs/05-servers-nfs.md)
- [Samba Server](docs/05-servers-samba.md)
- [DHCP Server](docs/05-servers-dhcp.md)
- [Mail Server](docs/05-servers-mail.md)
- [MariaDB Server](docs/05-servers-mariadb.md)
